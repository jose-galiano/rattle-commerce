...
(function () {
  ...
  var cartContentModal = $('#mobileCartContent');

  window.addEventListener("touchstart", function (e) {
    if (!cartContentModal.is(e.target) && cartContentModal.has(e.target).length === 0) {
      $("#header").removeClass("active_link");
    }
  })

  $(".minicartMobile").click(function () {
