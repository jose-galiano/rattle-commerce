          ...
          currentAjaxRequest = $.getJSON(searchURL +'*&view=json', function(data) {
            ...
            if(data.results_count == 0) {
              ...
              $.each(data.results, function(index, item) {
                ...
                var link = $('<a data-no-instant></a>').attr('href', item.url);
                ...
                if(item.object_type == 'product') {
                  ...
                  link.append('<div class="title">' + item.title + '<br><span class="item-pricing"><a data-no-instant class="btn btn-primary btn-sm" href="' + item.url + '*">Read...</a></span></div>');

                } else if(item.object_type == 'page') {
                  if(item.thumbnail != 'NULL') {
                    link.append('<div class="thumbnail"><img class="lazyload blur-up" src="https://cdn.shopify.com/s/files/1/0276/4174/1415/files/doc-ico.png?v=1638952561"/></div>');
                  }                  
              ...
              if(data.results_count >= 5) {
                resultsList.append('<li class="all-results"><span class="title see-all"><a class="btn btn-primary act_btn ripple-surface" href="' + searchURL + '*">' + "View all results" + ' (' + data.results_count + ')</a></span></li>');
              }
